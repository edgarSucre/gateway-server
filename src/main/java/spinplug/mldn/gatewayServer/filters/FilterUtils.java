package spinplug.mldn.gatewayServer.filters;
...
public class FilterUtils {
    ...
    public static final String CORRELATION_ID = "spp-correlation-id";
    public static final String AUTH_TOKEN     = "spp-auth-token";
    public static final String USER_ID        = "spp-user-id";
    public static final String ORG_ID         = "spp-org-id";
